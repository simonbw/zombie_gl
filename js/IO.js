...
(function() {
  var BUTTON_THRESHOLD, B_FLASHLIGHT, B_RELOAD, B_RTRIGGER, K_DOWN, K_FLASHLIGHT, K_GAMEPAD_TOGGLE, K_LEFT, K_RIGHT, K_UP, K_ZOOM_IN, K_ZOOM_OUT, LOOK_THRESHOLD, MOVE_THRESHOLD,
  ...
  window.IO = (function() {
    ...
    IO.prototype.update2 = function(game) {
      return this.triggerPressed = false;
    };
